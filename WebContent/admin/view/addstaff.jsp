								...
								<div class="form-group" onsubmit="return saveInfo()">
									...
									<div class="col-sm-12" style="margin-top:20px;padding-bottom: 50px;">
										...
										<div class="col-sm-12">
											...
											<div class="col-sm-6">
												<input class="form-control txttext" type="text" name="txtfname" placeholder="Full Name" onkeypress="focusMe(this)" id="fn" required data-rule-minlength="6"/>
											</div>
											
											<p class="col-sm-1 mylabel">Gender :<p>
											<div class="col-sm-2 form-group">
									
												<select name="select1" class="form-control txttext" id="select1" required>
