				 ...
				 <h1>sth</h1>
                            ...
                            <div class="col-sm-6">
                                <div class="panel panel-success">
                                    <div class="panel-heading">
                                        Attendance For:
                                        <label id="attdate">2015/08/01</label>
                                    </div>
                                    <div class="panel-body">
                                 ...
                                 <label>Select type</label>
                                                <select class="form-control" id="attselect">
                                                    <option>Absent</option>
                                                    <option>Late</option>
                                                </select>
                                                <label>Attendance for class</label>
                                                <select class="form-control" id="attselect">
...
>>>>>>> .r119
                                                ...
                                                <label> Select Students</label>
                                                <select id="stdselect" class="form-control chosen-select" multiple tabindex="4">
                                                    <option value="United States">United States</option>
                                                    <option value="United Kingdom">United Kingdom</option>
                                                    <option value="Afghanistan">Afghanistan</option>
                                                    <option value="Aland Islands">Aland Islands</option>
                                                ...
                                                .fullCalendar({
                                                    ...
                                                    select: function (
                                                        ...
                                                        if (test) {
                                                            ...
                                                            eventData = {
                                                                title: test,
                                                                url: 'javascript:fee_add("' + test + '","' + start + '");',
                                                                start: start,
                                                                end: end
                                                            };
