...
<html lang="en">
	<head>
		<title>Material Admin - Lists</title>
	...
	<body class="menubar-hoverable header-fixed menubar-pin ">
					...
					<div class="section-body contain-lg">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-4">
								<article class="margin-bottom-xxl">
									<p>
										List tiles present collections of related content in a consistent format, using hierarchy to enhance readability by prioritizing a consistent type or set of content.
										This helps users to more easily find the most important information within the collection of content.
									</p>
								</article>
							</div><!--end .col -->
							<div class="col-lg-offset-1 col-md-8">
								...
								<em class="text-caption">Single line list (click to see the ink effect)</em>
								<div class="card">
									<div class="card-body no-padding">
								...
								<em class="text-caption">Single line list with icons</em>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END TILE CONTENT -->
						...
						<div class="row">
							...
							<div class="col-lg-offset-1 col-md-8">
										...
										<ul class="list divider-full-bleed">
											...
											<li class="tile">
												<a class="tile-content ink-reaction">
													...
													<div class="tile-text">Trevor Hanson</div>
												</a>
												<a class="btn btn-flat ink-reaction">
													<i class="fa fa-trash"></i>
												</a>
								...
								<em class="text-caption">Single line list with avatars and action buttons</em>
								<div class="card">
									<div class="card-body no-padding">
										<ul class="list">
											<li class="tile">
								...
								<em class="text-caption">Two-line list with action buttons</em>
							</div><!--end .col -->
						</div><!--end .row -->
						<div class="row">
							<div class="col-lg-3 col-md-4">
								<article class="margin-bottom-xxl">
									<p>
										Sometimes the primary action is an action button.
										You can place them in front.
									</p>
								</article>
							</div><!--end .col -->
							<div class="col-lg-offset-1 col-md-8">
								...
								<em class="text-caption">Two-line list with icons and action buttons</em>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END TILE ACTIONS -->
						...
						<!-- BEGIN INSET DIVIDERS -->
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Dividers</h2>
							</div><!--end .col -->
							<div class="col-lg-8">
								<p class="lead">
									Dividers group and separate content within lists and page layouts.
									The divider is a thin rule, lightweight yet sufficient to distinguish content visually and spatially.
								</p>
							</div><!--end .col -->
							<div class="col-lg-12">
							...
							<div class="col-lg-offset-1 col-md-8">
								...
								<em class="text-caption">Two-line list with half-inset divider</em>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END INSET DIVIDERS -->

						<!-- BEGIN FULL-BLEED DIVIDERS -->
						<div class="row">
							<div class="col-lg-12">
							...
							<div class="col-lg-3 col-md-4">
								<article class="margin-bottom-xxl">
									<p>
										Full-bleed dividers separate distinct content sections.
									</p>
								</article>
							</div><!--end .col -->
							<div class="col-lg-offset-1 col-md-8">
										...
										<ul class="list divider-full-bleed">
											...
											<li class="tile">
												<a class="tile-content ink-reaction">
													...
													<div class="tile-icon">
														<img src="../../assets/img/avatar12.jpg?1404026783" alt="" />
													</div>
												</a>
											</li>
											<li class="tile">
												<a class="tile-content ink-reaction">
													...
													<div class="tile-icon">
														<img src="../../assets/img/avatar14.jpg?1404026812" alt="" />
													</div>
												</a>
											</li>
										</ul>
								...
								<em class="text-caption">Multi-line list with full-bleed dividers</em>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END FULL-BLEED DIVIDERS -->

						<!-- BEGIN MIXED LIST -->
						<div class="row">
							<div class="col-lg-12">
								<h4>Mixing elements</h4>
							</div><!--end .col -->
							<div class="col-lg-3 col-md-4">
								<article class="margin-bottom-xxl">
									<p>
										You can mix any element together to create a list which suits your needs.
									</p>
								</article>
							</div><!--end .col -->
							<div class="col-lg-offset-1 col-md-8">
											...
											<li class="tile">
												<a class="tile-content ink-reaction">
													...
													<div class="tile-text">
														Two-line item
														<small>
															Secondary text lorem ipsum dolor.
														</small>
													</div>
												</a>
											</li>
								...
								<em class="text-caption">You can mix different elements in 1 list</em>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END MIXED LIST -->
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Sortable</h2>
							</div><!--end .col -->
							<div class="col-lg-12">
								<h4>Easy sorting</h4>
							</div><!--end .col -->
						...
						<div class="row">
							<div class="col-lg-12">
								<h4>Nestable Lists</h4>
							</div><!--end .col -->
							<div class="col-lg-3 col-md-4">
								<article class="margin-bottom-xxl">
									<p>
										The nestable list plugin is also included.
										You can use the button classes to style it the way you like.
									</p>
								</article>
							</div><!--end .col -->
							<div class="col-lg-offset-1 col-md-8">
									...
									<div class="card-body">
										<div class="row">
												...
												<div class="dd nestable-list">
													<ol class="dd-list">
														<li class="dd-item tile" data-id="1">
															<div class="dd-handle btn btn-default-light">Item 1</div>
														</li>
														<li class="dd-item" data-id="2">
															<div class="dd-handle btn btn-default-light">Item 2</div>
														</li>
														<li class="dd-item" data-id="3">
															<div class="dd-handle btn btn-default-light">Item 3</div>
															<ol class="dd-list">
																<li class="dd-item" data-id="4">
																	<div class="dd-handle btn btn-default-light">Item 4</div>
																</li>
																<li class="dd-item" data-id="5">
																	<div class="dd-handle btn btn-default-light">Item 5</div>
																</li>
																<li class="dd-item" data-id="6">
																	<div class="dd-handle btn btn-default-light">Item 6</div>
																</li>
																<li class="dd-item" data-id="7">
																	<div class="dd-handle btn btn-default-light">Item 7</div>
																</li>
															</ol>
														</li>
													</ol>
											...
											<div class="col-lg-6">
												<div class="dd nestable-list">
													<ol class="dd-list">
														<li class="dd-item list-group" data-id="8">
															<div class="dd-handle btn btn-default-light"></div>
															<div class="btn btn-default-light">Item 8</div>
														</li>
														<li class="dd-item list-group" data-id="9">
															<div class="dd-handle btn btn-default-light"></div>
															<div class="btn btn-default-light">Item 9</div>
														</li>
														<li class="dd-item list-group" data-id="10">
															<div class="dd-handle btn btn-default-light"></div>
															<div class="btn btn-default-light">Item 10</div>
														</li>
														<li class="dd-item list-group" data-id="11">
															<div class="dd-handle btn btn-default-light"></div>
															<div class="btn btn-default-light">Item 11</div>
															<ol class="dd-list">
																<li class="dd-item list-group" data-id="12">
																	<div class="dd-handle btn btn-default-light"></div>
																	<div class="btn btn-default-light">Item 12</div>
																</li>
																<li class="dd-item list-group" data-id="13">
																	<div class="dd-handle btn btn-default-light"></div>
																	<div class="btn btn-default-light">Item 13</div>
																</li>
																<li class="dd-item list-group" data-id="14">
																	<div class="dd-handle btn btn-default-light"></div>
																	<div class="btn btn-default-light">Item 14</div>
																</li>
															</ol>
														</li>
													</ol>
								...
								<em class="text-caption">Nestable Lists</em>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END NESTABLE LISTS -->
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="gui-folder">
							...
							<ul>
								...
								<li><a href="../../html/ui/lists.html" class="active"><span class="title">Lists</span></a></li>
		...
		<script src="../../assets/js/core/demo/DemoUILists.js"></script> -->
		<!-- END JAVASCRIPT -->
